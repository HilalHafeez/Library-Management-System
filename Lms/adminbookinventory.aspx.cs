    ...
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        void updateBookByID()
        {
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl set book_id=@book_id, book_name=@book_name, genre=@genre, author_name=@author_name, publisher_name=@publisher_name, publish_date=@publish_date, language=@language, edition=@edition, book_cost=@book_cost, no_of_pages=@no_of_pages, book_description=@book_description, actual_stock=@actual_stock, current_stock=@current_stock, book_img_ink=@book_img_ink where book_id='" + TextBox1.Text.Trim() + "'", con);
                    ...
                    cmd.Parameters.AddWithValue("@book_img_ink", filepath);
                    cmd.ExecuteNonQuery();
                    con.Close();
                    GridView1.DataBind();
        ...
        void fillAuthorPublisherValues()
        {
            try
            {
                ...
                cmd = new SqlCommand("SELECT publisher_name from publisher_matser_tbl;", con);
        ...
        void addNewBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl(book_id,book_name,genre,author_name,publisher_name,publish_date,language,edition,book_cost,no_of_pages,book_description,actual_stock,current_stock,book_img_ink) values(@book_id,@book_name,@genre,@author_name,@publisher_name,@publish_date,@language,@edition,@book_cost,@no_of_pages,@book_description,@actual_stock,@current_stock,@book_img_ink)", con);
                cmd.Parameters.AddWithValue("@book_id", TextBox1.Text.Trim());
                cmd.Parameters.AddWithValue("@book_name", TextBox2.Text.Trim());
                cmd.Parameters.AddWithValue("@genre", genres);
                cmd.Parameters.AddWithValue("@author_name", DropDownList3.SelectedItem.Value);
        ...
        void getBookByID()
        {
            try
            {
                ...
                if (dt.Rows.Count >= 1)
                {
                    ...
                    global_filepath = dt.Rows[0]["book_img_ink"].ToString();
                }
                else
                {
                    Response.Write("<script>alert('Invalid Book ID');</script>");
